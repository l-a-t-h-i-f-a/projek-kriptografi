  ...
  <html lang="en">
    ...
    <div class="header-3-3 container-xxl mx-auto p-0 position-relative" style="font-family: 'Poppins', sans-serif">
      ...
      <div class="hr">
        ...
        <center>
            <h1>Review</h1><br>
            <p>Please write your testimonials and reviews on our products and services.</p>
        </center><br>

        <div align="center">
            <form action="enkripsi_review.php" method="POST">
                <textarea name="comment" id="Textarea1" rows="10" cols="50"></textarea> <br><br>
                <label for="fname">Please add a photo (jpg)</label><br><br>
                <div class="col-lg-4">
