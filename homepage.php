<!DOCTYPE html>
  <html lang="en">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
          <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link px-md-4" href="kontak.php">Contact</a>
            </li>
            <li class="nav-item">
              <a class="nav-link px-md-4" href="kritik.php">Critics and Suggestions</a>
            </li>
            <!-- <li class="nav-item">
        ...
        <div class="mx-auto d-flex flex-lg-row flex-column hero">
          ...
          <div
            ...
            <h1 class="title-text-big">
              What is<br class="d-lg-block d-none" />
              <span style="color: #4E91F9">MALA Fish Store</span>?<br class="d-lg-block d-none" />
              
            </h1>
            <p class="text-caption">
              MALA Fish Store is a fish shop named after the owner's name. The store provides various types of quality fish for aquarium, pond, or consumption needs. With friendly and professional service, Mala Fish Store is committed to providing the best products to its customers. The store may also offer fish-keeping-related equipment and accessories, as well as provide information and support to ensure the fish stay healthy and thrive.
            </p>
    ...
    <footer>
        <center>
      <p class="text-caption">Copyright @ 2024 Lathifa</p></center>
      <br>
    </footer>
  </section> 
